...
/////////////////
const BotName = 'DyeMinecraft Bot☄'; 
const instagram = 'https://instagram.com/riandi.andii'; 
const telegram = 'https://t.me/DyeeXR'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UC-HwA6pEAO8WwGPrawHCQOA';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@riandi.andii`)
})
